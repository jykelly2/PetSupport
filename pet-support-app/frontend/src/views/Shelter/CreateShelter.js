...
import { createShelter } from '../../actions/ShelterActions';
...
import styles from "assets/jss/material-dashboard-react/views/Shelter/createShelterStyle"
// core components
...
export default function CreateShelter(props){
    ...
    const shelterCreate = useSelector((state) => state.shelterCreate);
    const { success, loading, error } = shelterCreate;
          ...
          <GridItem xs={12} sm={12} md={8}>
            ...
            <form className={classes.form} onSubmit={formik.handleSubmit} >
              ...
              <CardBody>
                ...
                <GridItem xs={12} sm={12} md={12}>              
                    <p>Upload Pictures:</p>
                    <FileUploader filesLimit={filesLimit}  setPictures={setPictures} ></FileUploader>
              </GridItem>
              </GridContainer>  */}      
              <GridContainer>
                  <GridItem xs={12} sm={12} md={12}>
              ...
              <CardFooter>
                <Button  type="submit" color="primary">Create Shelter</Button>
              </CardFooter>
              </form>
            </Card>
          </GridItem>
 ...
 // const [name, setName] = useState('');
    ...
    //     //const shelterAvailable = available == "Yes" ? true : false
    ...
    //         pictures: pictures,
    //         available: available,//shelterAvailable,
    //     }
    //     console.log(shelter)
...
/*export default class Shelter extends Component {
    ...
    onSubmit(e) {
       ...
       this.state.available = this.state.available == "Yes" ? true : false
        ...
        console.log(shelter);
        axios.post('http://localhost:5000/shelters/add',formData)
    ...
    return (
        ...
        <Container fluid>
            ...
            <Col md="8">
                <Card>
                <Card.Header>
                    <Card.Title as="h4">Create Shelter</Card.Title>
                </Card.Header>
                <Card.Body>
...
//export default Shelter;*/
    ...
    //     if (pictureSrc.target.files){
    //         let images = pictureSrc.target.files;
    //         console.log(images)
    //         setPictures(images)
    ...
    //   }
       /* <div>
                                ...
                                <input type="file" multiple onChange={(pictureSrc) => onChangePicture(pictureSrc)} />
                            </div> */