...
export const CLIENTS_LAST_MONTH_REQUEST = 'CLIENTS_LAST_MONTH_REQUEST';
export const CLIENTS_LAST_MONTH_SUCCESS = 'CLIENTS_LAST_MONTH_SUCCESS';
export const CLIENTS_LAST_MONTH_FAIL = 'CLIENTS_LAST_MONTH_FAIL';

export const CLIENTS_RECENT_REQUEST = 'CLIENTS_RECENT_REQUEST';
export const CLIENTS_RECENT_SUCCESS = 'CLIENTS_RECENT_SUCCESS';
export const CLIENTS_RECENT_FAIL = 'CLIENTS_RECENT_FAIL';

export const CLIENTS_TODAY_REQUEST = 'CLIENT_TODAY_REQUEST';
export const CLIENTS_TODAY_SUCCESS = 'CLIENT_TODAY_SUCCESS';
export const CLIENTS_TODAY_FAIL = 'CLIENT_TODAY_FAIL';
...
export const CLIENT_ADDRESS_MAP_CONFIRM = 'CLIENT_ADDRESS_MAP_CONFIRM';